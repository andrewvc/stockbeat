...
`${GOPATH}/src/github.com/andrewvc/stockbeat`
...
```
git remote set-url origin https://github.com/andrewvc/stockbeat
...
To clean  Stockbeat source code, run the following commands:
...
```
mkdir -p ${GOPATH}/src/github.com/andrewvc/stockbeat
git clone https://github.com/andrewvc/stockbeat ${GOPATH}/src/github.com/andrewvc/stockbeat
```
